  ...
  return (
    <aside className={styles.wrap}>
      <div className={styles.card}>
        ...
        <Link className={[styles.item, active === 'orders' ? styles.active : ''].join(' ')} to="/personal/orders">
          订单
        </Link>
        ...
        <div className={[styles.item, isCommonInfo ? styles.groupActive : ''].join(' ')}>
          常用信息
          <span className={isCommonInfo ? styles.caretUpBlue : styles.caretDown} aria-hidden="true" />
        </div>
        {isCommonInfo ? (
          <div className={styles.subList}>
            <div className={[styles.subItem, styles.subActive].join(' ')}>常用旅客信息</div>
        ...
        <div
          className={[styles.item, styles.groupHead, active === 'profile' ? styles.groupActive : ''].join(' ')}
        >
          个人中心
        ...
        {active === 'profile' ? (
          <div className={styles.subList}>
            <div className={[styles.subItem, styles.subActive].join(' ')}>我的信息</div>
